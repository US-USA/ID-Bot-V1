...
from BOTidSBot.Modules.Buttons import ID_BUTTON, INFO_BUTTON
...
@BOTidSBot.on_message(filters.private & filters.command("id"))
...
@BOTidSBot.on_message(filters.private & filters.command("info"))
